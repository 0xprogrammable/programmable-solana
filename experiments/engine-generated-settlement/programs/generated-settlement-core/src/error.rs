...
pub enum CoreError {
    ...
    #[msg("The wire codec rejected a capability or payload")]
    InvalidWireEncoding,
    ...
    #[msg("The engine-generated output exceeds Core-accounted liquidity")]
    ...
    RequestExpired,
    #[msg("The engine-generated output is below the user's minimum")]
    ...
    #[msg("The engine receipt authenticates a different request")]
    EngineReceiptRequestMismatch,
}
