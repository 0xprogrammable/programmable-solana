//! Cancels a Draft or Active authorization while retaining its tombstone.
...
use crate::{
    ...
    state::cancel_stored_authorization_exact,
};

pub const CANCEL_STORED_AUTHORIZATION_ACCOUNT_COUNT: usize = 3;

const ACTOR_INDEX: usize = 0;
const AUTHORIZATION_INDEX: usize = 1;
const INSTRUCTIONS_SYSVAR_INDEX: usize = 2;

pub fn handle_cancel_stored_authorization(
    program_id: &Pubkey,
    ...
    require_eq!(
        accounts.len(),
        CANCEL_STORED_AUTHORIZATION_ACCOUNT_COUNT,
    ...
    cancel_stored_authorization_exact(
